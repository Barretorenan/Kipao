...
//        return null;
    ...
    @PostMapping("/criar-produtos/{nome}")
    public ItensModel criarProdutos(@PathVariable String nome) {
        // Retorna a lista de produtos
        ItensModel novo = new ItensModel();
        novo.setNome(nome);
        novo.setDescricao(nome);
        novo.setCategoria(nome);
        return itensRepository.save(novo);/**/
//        return null;
    }
}
class Product {
